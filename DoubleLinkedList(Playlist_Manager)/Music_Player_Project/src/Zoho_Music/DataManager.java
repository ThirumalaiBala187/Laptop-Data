...
//		availableUsers.add(new Curator("Leo Dhas","leodhas@718","badassleom@123","Curator",new ArrayList<String>(Arrays.asList("Yuvan Shankar Raja","A.R.Rahman","Devi Sri Prasad"))));
	...
	private void intializeTracks() {
		...
		availableSongs.add(new Track("Ordinary Person", "Anirudh Ravichander","Leo",2.3));
		
		availableSongs.add(new Track("Whistle Podu", "Thalapathy Vijay","The Greatest Of All Time",5.1));
		...
		availableSongs.add(new Track("Matta", "Yuvan Shankar Raja","The Greatest Of All Time",3.7));
		...
		availableSongs.add(new Track("Ratata", "Anirudh Ravichander","Leo",2.1));
		...
		availableSongs.add(new Track("Arabic Kuthu", "Anirudh Ravichander","Beast",4.2));
