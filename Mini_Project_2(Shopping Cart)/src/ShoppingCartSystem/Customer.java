...
public class Customer extends User implements UserInterface {
    ...
    public Customer(String name, byte age, Gender gender, String userName, String password, int role, String mobileNumber){

        super(name, age, gender, userName, password, role, mobileNumber);
        
        this.likedProduct = null;
	...
	void viewDashboard() {
		...
		System.out.println("\nHow can we help you ?\n(1)=> 'Trending items' of the week.\n(2) => 'Most Liked Product'.\n(3) => 'Your favourites'.\n(4) => 'Your orders'.\n(5) => View 'Cart'.\n(6) => 'Search' Product.\n(7) => 'View/ Update your profile'\n(8) => 'Logout'.\n");
...
//    // To buy a product......
//
//	public void buyProduct(Product productToBuy, String address, String mobileNo){
//
