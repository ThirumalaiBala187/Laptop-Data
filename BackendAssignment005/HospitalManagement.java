...
public class HospitalManagement {
	...
	static PriorityQueue<Patient> patientList = new PriorityQueue<>(new SeverityComparator().thenComparing(new TimeComparator()));
		...
		loop1 : while(true) {
			...
			case 2:
				...
				for(int i=0;i<count;i++) {
					...
					patientList.add(patientToAdmit);
	...
	static void treatPatients() {
		...
		Collections.sort(patients, new SeverityComparator());
