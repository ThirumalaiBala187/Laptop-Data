...
fetch("/CourseServlet").then(response => response.json()).then(data =>{
    ...
    data.forEach(course => {
        ...
        inner2.classList.add("money");
        inner2.innerText = "🤖";
        innerDiv4.appendChild(inner4);

        let inner5 = document.createElement("div");
        inner3.classList.add("pre");
        inner3.innerText = "Preview"
